...
export const Icon = ({
  ...
  data?: { name?: string | null; color?: string | null; size?: string | number | null; style?: string | null } | null;
  parentColor?: string;
  className?: string;
  tinaField?: string;
}) => {
  ...
  const iconSizeClasses = typeof size === 'string' ? iconSizeClass[size] : iconSizeClass[Object.keys(iconSizeClass)[size as number]];
